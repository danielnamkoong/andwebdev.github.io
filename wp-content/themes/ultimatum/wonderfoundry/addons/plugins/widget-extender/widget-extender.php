...
if(!class_exists('Ultimatum_Widget_Extender')) {
    class Ultimatum_Widget_Extender
    {
        ...
        {
            $instance['ult_hidden_desktop'] = isset($instance['ult_hidden_desktop']) ? $instance['ult_hidden_desktop'] : false;
            $instance['ult_hidden_tablet'] = isset($instance['ult_hidden_tablet']) ? $instance['ult_hidden_tablet'] : false;
            $instance['ult_hidden_mobile'] = isset($instance['ult_hidden_mobile']) ? $instance['ult_hidden_mobile'] : false;
        ...
        function widget_templates()
        {
            $widget_templates = array(
                'panel-default' => array(
                    ...
                    'after_title' => array('action' => 'replace', 'value' => '</h3></div><div class="panel-body">'),
