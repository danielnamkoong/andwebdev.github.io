...
jQuery(document).ready(function() {
	...
	const documentHeight1 = jQuery(document).height();
	const windowHeight1   = jQuery(window).height();
		// console.log("----------------------------");
	...
	function getTrackHeight(percent) {
		let trackHeight = (documentHeight1 - windowHeight1) * percent;
...
jQuery(document).ready(function() {
	jQuery(".article1, .article2, .article3, .article4, .article5").scroll(function() {
		const distanceToTop2  = jQuery(this).scrollTop();
		const documentHeight2 = jQuery(".imgContent article .content.active").height();
		const windowHeight2   = jQuery(this).height();
			// console.log("----------------------------");
		...
		const percentScrolled2 = distanceToTop2/((documentHeight2 + 100) - windowHeight2) * 100;
...
jQuery(document).ready(function() {
	...
	jQuery(window).scroll(function() {
		const distanceToTop  = jQuery(this).scrollTop();
		...
		// 	PROGRESS BAR 1
		const percentScrolled = distanceToTop/(documentHeight - windowHeight) * 100;
